...
//zrob funkcje za pomoca switcha (jak restauracja) musi byc danie albo napoj i to danie kosztuje tyle i tyle zlotych funkcja(zestaw big mac) - ma dac input ile kasy kosztuje - i default jezeli nie ma tego co jest w menu
    //KOD USTALAJACY GODZINE MASZYNY
// KOD USTALAJACY DZIEN.MIESIAC
   function LiczbaNaStringDzienTygodnia() {
var DzienTygodnia = new Date().getDay(); 
    var JakaGodzina = new Date().getHours();
    var JakaMinuta = new Date().getMinutes();
    var JakaFullGodzina = JakaGodzina + ":" + JakaMinuta;
    switch (DzienTygodnia) {
       case 0:
            console.log("dzis jest niedziela" )
            break;
        ...
        case 3:
            ...
            break;
        case 4:
            console.log("dzis jest czwartek, godzina: " + JakaFullGodzina)
            break;
        case 5:
            console.log("dzis jest piatek")
            break;
...
console.log(LiczbaNaStringDzienTygodnia());
...
var RandomCostSchengenBurgers123 = Math.round(Math.random() * 100)

var siemasiema = Math.round(Math.random() * 10);
console.log(siemasiema);
